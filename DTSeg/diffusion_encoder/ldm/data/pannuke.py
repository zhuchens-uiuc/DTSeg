...
class CelebAHQTrain(FacesBase):
    def __init__(self, size, keys=None):
        super().__init__()
        root = "/data114_2/shaozc/CellHE/PanNuke/Fold 2/images/fold2/images/"
        paths = sorted(glob.glob(root + '*.png'))
        # root = "/data114_2/shaozc/LiveCell/images/livecell_train_val_images_split/"
        # paths = sorted(glob.glob(root + '*.png'))
...
class CelebAHQValidation(FacesBase):
    def __init__(self, size, keys=None):
        super().__init__()
        root = "/data114_2/shaozc/CellHE/PanNuke/Fold 3/images/fold3/images/"
        paths = sorted(glob.glob(root + '*.png'))
        # root = "/data114_2/shaozc/LiveCell/images/livecell_train_val_images_split/"
        # paths = sorted(glob.glob(root + '*.png'))
