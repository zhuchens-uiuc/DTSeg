...
### https://github.com/MichalGeyer/plug-and-play/blob/4e7f703df5f5746011127f058e07ece415564910/ldm/models/diffusion/ddim.py#L272
### 
    ...
    def encode_ddim(self, img, num_steps,conditioning, unconditional_conditioning=None ,unconditional_guidance_scale=1.):
        ...
        T = 999
        c = T // num_steps
        iterator = tqdm(range(0,T - c ,c), desc='DDIM Inversion', total= num_steps)
