...
from models import ModelInterfaceBoth
...
def make_parse():
    ...
    parser.add_argument('--config', default='scripts/monusac_412/UNetFormer_0.1_789_aug.yaml',type=str)
...
def main(cfg):
    ...
    model = ModelInterfaceBoth(**ModelInterface_dict)
