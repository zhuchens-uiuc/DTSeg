...
from models import ModelInterfaceImage
...
def make_parse():
    ...
    parser.add_argument('--config', default='scripts/consep/unet_0.1_aug_unlabel_789.yaml',type=str)
...
def main(cfg):
    ...
    model = ModelInterfaceImage(**ModelInterface_dict)
