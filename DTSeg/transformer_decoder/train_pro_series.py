...
from models.model_interface_pro_series import ModelInterfaceProSeries
...
def make_parse():
    ...
    parser.add_argument('--config', default='scripts/monusac/UNetFormer_0.1_789_big_series.yaml',type=str)
...
def main(cfg):
    ...
    model = ModelInterfaceProSeries(**ModelInterface_dict)
