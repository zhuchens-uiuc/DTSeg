...
from models import ModelInterfacePro
...
def make_parse():
    ...
    parser.add_argument('--config', default='scripts/pannuke/UNetFormer_0.1_789.yaml',type=str)
...
def main(cfg):
    ...
    model = ModelInterfacePro(**ModelInterface_dict)
