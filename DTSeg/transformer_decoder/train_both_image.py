...
from models.model_interface_both_image import ModelInterfaceBothImage
...
def make_parse():
    ...
    parser.add_argument('--config', default='scripts/pannuke/aggregrate_unet_unet_0.1.yaml',type=str)
...
def main(cfg):
    ...
    model = ModelInterfaceBothImage(**ModelInterface_dict)
