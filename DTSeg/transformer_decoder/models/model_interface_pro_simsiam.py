...
class ModelInterfaceProSimsiam(pl.LightningModule):

    #---->init
    def __init__(self, model, loss, optimizer, **kargs):
        super(ModelInterfaceProSimsiam, self).__init__()
        ...
        self.feature_extractor = ResNetNoGAP(arch='resnet34')
        file_path_base = '/data114_2/shaozc/simsiam/checkpoints/resnet34/big/checkpoint_199.pth.tar'
        ...
        msg = self.feature_extractor.load_state_dict(model_dict)
        print(msg)
    ...
    def on_train_batch_start(self, batch, batch_idx, dataloader_idx):
        ...
        for i in range(batch_size):
            ...
            features = nn.functional.interpolate(features, scale_factor=32, mode='bilinear')
            batch_feature.append(features)
        batch_feature = torch.cat(batch_feature, dim=0)

        batch['data'] = batch_feature
